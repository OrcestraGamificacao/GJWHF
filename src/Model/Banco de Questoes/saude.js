...
function questoesSaude(){
    const saudeQ1 = new Questao(1, 'texto introdutorio - saude 1', 'Pergunta saude 1', '1a - saude', '1b - saude', '1c - saude', '1d - saude (certa)', '1d - saude (certa)', 'Você acertou!', 'Explicação')

    const saudeQ2 = new Questao(2, 'texto introdutorio - saude 2', 'Pergunta saude 2', '2a - saude', '2b - saude (certa)', '2c - saude', '2d - saude', '2b - saude (certa)', 'Você acertou!', 'Explicação')

    const saudeQ3 = new Questao(3, 'texto introdutorio - saude 3', 'Pergunta saude 3', '3a - saude (certa)', '3b - saude', '3c - saude', '3d - saude', '3a - saude (certa)', 'Você acertou!', 'Explicação')

    const saudeQ4 = new Questao(4, 'texto introdutorio - saude 4', 'Pergunta saude 4', '4a - saude', '4b - saude', '4c - saude (certa)', '4d - saude', '4c - saude (certa)', 'Você acertou!', 'Explicação')
