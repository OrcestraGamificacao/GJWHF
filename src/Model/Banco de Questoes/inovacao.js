...
function questoesInovacao() {
    const inovQ1 = new Questao(1,
        ...
        'Que tipo de produto a designer Meriem confecciona para mulheres?',
        'Roupas íntimas',
        'Kaftans',
        'Cintas modeladoras',
        'Kimonos',
    ...
    const inovQ2 = new Questao(2,
        ...
        'Qual o objetivo principal que a organização de Hanae Bezad promove?',
        'Oportunidades de liderança feminina em organizações comunitárias',
        'Oportunidades de emprego para mulheres em áreas rurais e semi-urbanas',
        'Educação de mulheres de origens precárias',
        'Inclusão de mulheres no desenvolvimento da economia e tecnologia',
        'Inclusão de mulheres no desenvolvimento da economia e tecnologia',
    ...
    const inovQ6 = new Questao(6,
        ...
        'Trazer abordagens mais holísticas e abrangentes',
        'Aumentar o viés de gênero no campo',
        'Reforçar as normas tradicionais de gênero',
        'Aumentar a homogeneidade nas decisões',
        'Trazer abordagens mais holísticas e abrangentes',
    ...
    const inovQ7 = new Questao(7,
        ...
        'Promoção de produtos de luxo',
        'Exportação de produtos africanos',
        'Estabelece pontos de coleta para retirada pessoal dos produtos',
        'Minimiza os custos de frete para os clientes',
        'Estabelece pontos de coleta para retirada pessoal dos produtos',
    ...
    const inovQ8 = new Questao(8,
        ...
        'Qual o impacto que a associação da marca de Bouchra Ezzahraoui com personalidades femininas de renome?',
        'Reforça estereótipos de gênero',
        'Criação de marketing com celebridades superficiais',
        'Fortalece a imagem e o reconhecimento da marca',
        'Provoca a diminuição da demanda pelos produtos da empresa',
        'Fortalece a imagem e o reconhecimento da marca',
