...
function questoesEducacao() {
    ...
    const eduQ2 = new Questao(2,
        'Aicha Ech-Channa foi fundadora e presidente da Associação Solidàriaé Féminine, a qual busca acabar com a marginalização e a estigmatização sobre mães solteiras na sociedade marroquina.',
        'Aicha Ech-Channa possibilitou para mães solteiras:',
        'A garantia de uma ajuda financeira mensal',
        'O desenvolvimento de seus próprios meios de subsistência através de programas de instrução vocacional',
        'O fim da estigmatização da sociedade marroquina',
        'A garantia de escola de qualidade para os filhos dessas mães solteiras',
        'O desenvolvimento de seus próprios meios de subsistência através de programas de instrução vocacional',
    ...
    const eduQ4 = new Questao(4,
        ...
        'Restrição das oportunidades de desenvolvimento pessoal e profissional',
        'Exacerbar a desigualdade de poder entre homens e mulheres',
    ...
    'A ampliação de vendas de artigos de luxo', 
    'Projetos sociais, culturais, educacionais e de saúde', 
    'O lançamento de sua marca de cosméticos e beleza Yan&One voltada para ajudar meninas a se sentirem bem com sua autoimagem, mesmo com as pressões sociais', 
    'O lançamento de um novo marketplace de comércio com o objetivo de aumentar a acessibilidade nesse meio', 
    'Projetos sociais, culturais, educacionais e de saúde', 
    'Akhannouch por meio da Aksal Social Initiative trabalha diariamente para apoiar ações que contemplam aspectos sociais, culturais, econômicos, educacionais e de saúde, os quais impactam o cotidiano e o futuro de diversas pessoas.')

    const eduQ7 = new Questao(7, 
    'Ghizlane Agzenai possui um estilo artístico único, remetente à Arte Geométrica, com formas e cores geométricas que transportam o olho para uma dimensão metafísica, buscando um ambiente misterioso, enigmático, sonhador, trazendo um sentimentalismo a quem vê.', 
    'As obras de Ghizlane Agzenai buscam trazer ao mundo:', 
    'Boas vibrações e positividade', 
    'Críticas a problemas da sociedade', 
    'Novos meios para viabilizar a educação de meninas', 
    'O aumento da valorização de paisagens marroquinas', 
    'Boas vibrações e positividade', 
    'A incrível artista Agzenai se define como um ser humano otimista que usa mais cores para compartilhar mais amor e luz.')

    const eduQ8 = new Questao(8, 'Hind Bouqartacha é uma fotógrafa, cinegrafista e proprietária do “GUILE STUDIO”. A fotografia foi para ela uma potente oportunidade criativa de imortalizar momentos, de se expressar livremente e de descobrir o mundo e a si mesma.', 
    'Hind Bouqartacha produziu a série ‘Pedaço de Pão’, que tinha como objetivo ressaltar que tipo de história?', 
    'A história de estudantes marroquinas', 
    'A história do comércio no Marrocos', 
    'A história de comidas típicas do Marrocos', 
    'A história de mulheres trabalhadoras', 
    'A história de mulheres trabalhadoras', 
    ...
    'Com dupla-nacionalidade, francesa e marroquina, Ilham Kadri é graduada em engenharia pela Escola Europeia de Química, Polímeros e Ciência dos Materiais, em Estrasburgo, França, e possui doutorado em físico-química macromolecular pela Universidade Louis Pasteur, em Estrasburgo.', 
    'Como a dupla-nacionalidade de Ilham Kadri pode ter influenciado sua perspectiva científica e suas contribuições para a ciência?', 
    'Facilitando a obtenção de patentes internacionais para suas descobertas', 
    'Incorporando diferentes abordagens culturais e filosóficas em suas pesquisas', 
    'Tornando-a mais habilidosa em diferentes técnicas de laboratório', 
    'Permitindo o acesso a recursos financeiros adicionais para pesquisa', 
    'Incorporando diferentes abordagens culturais e filosóficas em suas pesquisas', 
...
export default questoesEducacao