...
function questoesEducacao() {
    const eduQ1 = new Questao(1,
        ...
        'Ela é a co-fundadora da Womenquake. Sobre o que é essa instituição?',
    ...
    const eduQ2 = new Questao(2,
        ...
        'Asmaa criou uma associação, sobre o que é a associação baseado na sua formação?',
    ...
    const eduQ3 = new Questao(3,
        ...
        'Bouqartacha produziu a série ‘Pedaço de Pão’, que tinha como objetivo ressaltar que tipo de história?',
