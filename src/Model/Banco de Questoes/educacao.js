...
function questoesEducacao(){
    const eduQ1 = new Questao(1, 'texto introdutorio - educaçao 1', 'Pergunta educaçao 1', '1a - educaçao', '1b - educaçao', '1c - educaçao', '1d - educaçao (certa)', '1d - educaçao (certa)', 'Explicação')

    const eduQ2 = new Questao(2, 'texto introdutorio - educaçao 2', 'Pergunta educaçao 2', '2a - educaçao', '2b - educaçao (certa)', '2c - educaçao', '2d - educaçao', '2b - educaçao (certa)', 'Explicação')

    const eduQ3 = new Questao(3, 'texto introdutorio - educaçao 3', 'Pergunta educaçao 3', '3a - educaçao (certa)', '3b - educaçao', '3c - educaçao', '3d - educaçao', '3a - educaçao (certa)', 'Explicação')

    const eduQ4 = new Questao(4, 'texto introdutorio - educaçao 4', 'Pergunta educaçao 4', '4a - educaçao', '4b - educaçao', '4c - educaçao (certa)', '4d - educaçao', '4c - educaçao (certa)', 'Explicação')
